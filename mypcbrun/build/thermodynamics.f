C $Header: /u/gcmpack/MITgcm/model/src/thermodynamics.F,v 1.143 2013/02/19 13:42:19 jmc Exp $
...
C $Header: /u/gcmpack/MITgcm/pkg/timeave/TIMEAVE_OPTIONS.h,v 1.3 2011/12/24 01:09:41 jmc Exp $
C $Name: checkpoint64g $
...
C                      index into fVerTerm.
      ...
      Real*8 fVerP   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2,PTRACERS_num)
      Real*8 kappaRTr(1-OLx:sNx+OLx,1-OLy:sNy+OLy,PTRACERS_num)
