...
c      INTEGER nriver     
      ...
      ! Local variables
      !-------------------------------------------------------------
      Real*8  SURPCBa(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
c Remove PCBi tracer. (hma, 15 Jul 2014)
c      Real*8  SURPCBi(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  SURPCBP(1-OLx:sNx+OLx,1-OLy:sNy+OLy)


c #ifdef HGPRIVER
c      Real*8  SURHgR(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nrmax) 
c #endif             
c #ifdef METHY_MODE      
c      Real*8  SURDMHg(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
c #endif
