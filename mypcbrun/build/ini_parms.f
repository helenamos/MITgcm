C $Header: /u/gcmpack/MITgcm/model/src/ini_parms.F,v 1.253 2013/04/22 02:34:27 jmc Exp $
...
c     Real*8 pressure(1-OLx:sNx+OLx,1-OLy:sNy+OLy,1:Nr,nSx,nSy)
...
C     dQdTfile     :: File containing thermal relaxation coefficient
      ...
      Real*8 trac_EvPrRn
      Real*8 zonal_filt_lat, gravitySign
...
C--   Continuous equation parameters
     ...
     & celsius2K, atm_Cp, atm_Rd, atm_Rq, atm_Po,
...
C--   Input files
      NAMELIST /PARM05/
     & bathyFile, topoFile, shelfIceFile, diffKrFile,
