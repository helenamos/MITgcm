...
C         even if, for convienience, it will be loaded into array KPPghat
     ...
     &        intime1*Ifprd +offlineIter0
       ...
       CALL EXCH_XYZ_RS ( wvel0,  myThid  )
       CALL EXCH_XYZ_RS ( wvel1,  myThid  )
       CALL EXCH_XYZ_RS ( tave0 ,  myThid  )
       CALL EXCH_XYZ_RS ( tave1 ,  myThid  )
       CALL EXCH_XYZ_RS ( save0,  myThid  )
       CALL EXCH_XYZ_RS ( save1,  myThid  )
       CALL EXCH_XYZ_RS ( conv0,  myThid  )
       CALL EXCH_XYZ_RS ( conv1,  myThid  )
       CALL EXCH_UV_AGRID_3D_RS( gmkx0, gmky0, .FALSE., Nr, myThid )
       CALL EXCH_UV_AGRID_3D_RS( gmkx1, gmky1, .FALSE., Nr, myThid )
       CALL EXCH_XYZ_RS ( gmkz0,  myThid  )
       CALL EXCH_XYZ_RS ( gmkz1,  myThid  )
       CALL EXCH_XY_RS ( hflx0 ,  myThid  )
       CALL EXCH_XY_RS ( hflx1 ,  myThid  )
       CALL EXCH_XY_RS ( sflx0,  myThid  )
       CALL EXCH_XY_RS ( sflx1,  myThid  )
       CALL EXCH_XY_RS ( icem0,  myThid  )
       CALL EXCH_XY_RS ( icem1,  myThid  )
       CALL EXCH_XYZ_RS ( kdfs0 ,  myThid  )
       CALL EXCH_XYZ_RS ( kdfs1 ,  myThid  )
       CALL EXCH_XYZ_RS ( kght0,  myThid  )
       CALL EXCH_XYZ_RS ( kght1,  myThid  )
