...
set libs     = ( -L${APPLIB_PATH} -L${APPLIB_PATH}/${PE}pe -lmitgcm_org_ocn_esmf_driver -lmitgcm_org_ocn -lmitgcmrtl ${complibs} -lesmf -lmitgcm_org_ocn_esmf_driver -lmitgcm_org_ocn -lmitgcmrtl  )
