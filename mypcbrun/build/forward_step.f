C $Header: /u/gcmpack/MITgcm/model/src/forward_step.F,v 1.215 2013/04/13 20:47:18 heimbach Exp $
...
C $Header: /u/gcmpack/MITgcm_contrib/darwin2/verification/monod_global_128x64x15/code/GMREDI_OPTIONS.h,v 1.1 2011/04/13 19:26:00 jahn Exp $
C $Name:  $
...
C--     Step forward fields and calculate time tendency terms.
      ...
      IF ( useGCHEM ) THEN
        CALL TIMER_START('GCHEM_APP_TENDENCY [FORWARD_STEP]',myThid)
        !CALL GCHEM_CALC_TENDENCY( myTime, myIter, myThid ) ! comment out by yanxu zhang
        CALL GCHEM_APP_TENDENCY( myTime, myIter, myThid )   ! a new wrapper by yanxu zhang 7/19/2013
        CALL TIMER_STOP ('GCHEM_APP_TENDENCY [FORWARD_STEP]',myThid)
      ENDIF
